...
class CandidateScore:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if not isinstance(self.hard_constraint_failures, Unset):
            ...
            for hard_constraint_failures_item_data in self.hard_constraint_failures:
                hard_constraint_failures_item = hard_constraint_failures_item_data.to_dict()
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for hard_constraint_failures_item_data in (_hard_constraint_failures or []):
            hard_constraint_failures_item = HardConstraintFailure.from_dict(hard_constraint_failures_item_data)
        ...
        next_contact_minutes = _parse_next_contact_minutes(d.pop("next_contact_minutes", UNSET))
        ...
        next_max_elevation_deg = _parse_next_max_elevation_deg(d.pop("next_max_elevation_deg", UNSET))
