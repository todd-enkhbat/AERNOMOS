...
from ...models.mission_json_export_response import MissionJsonExportResponse
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/missions/{mission_id}/exports/json".format(
...
) -> ErrorResponse | HTTPValidationError | MissionJsonExportResponse | None:
    if response.status_code == 200:
        response_200 = MissionJsonExportResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | HTTPValidationError | MissionJsonExportResponse]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ErrorResponse | HTTPValidationError | MissionJsonExportResponse
    """
