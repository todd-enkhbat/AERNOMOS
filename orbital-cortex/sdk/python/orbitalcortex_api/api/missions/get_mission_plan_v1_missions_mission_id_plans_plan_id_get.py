...
from ...models.mission_plan_detail_response import MissionPlanDetailResponse
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/missions/{mission_id}/plans/{plan_id}".format(
...
) -> ErrorResponse | HTTPValidationError | MissionPlanDetailResponse | None:
    if response.status_code == 200:
        response_200 = MissionPlanDetailResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | HTTPValidationError | MissionPlanDetailResponse]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ErrorResponse | HTTPValidationError | MissionPlanDetailResponse
    """
