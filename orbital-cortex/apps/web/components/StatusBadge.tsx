...
const statusClass: Record<JobStatus, string> = {
  ...
  scheduled: "border-[#25495a]/30 bg-[#25495a]/10 text-[#25495a]",
  running: "border-[#68735d]/30 bg-[#68735d]/10 text-[#4d5a45]",
  completed: "border-[#68735d]/30 bg-[#68735d]/10 text-[#3f5137]",
